bbdiese: src/token.cs src/parser.cs src/tag.cs src/bbcode.cs src/tag_handlers.cs src/AssemblyInfo.cs src/tag_handlers/simple.cs src/tag_handlers/link.cs src/tag_handlers/image.cs src/tag_handlers/color.cs
